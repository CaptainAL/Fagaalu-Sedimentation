...
## Waves
ax1.set_ylabel('Mean monthly \n Sig Wave ht (m)',color='b')
df['swell height'].plot(ax=ax1,color='b',ls='-',marker='None',label='Swell Ht')
for tl in ax1.get_yticklabels():
    tl.set_color('b')
## SSY
ax1_2 = ax1.twinx()
ax1_2.set_ylabel('SSY (tons/month)',color='r')
df['sediment loading'].plot(ax=ax1_2,color='r',ls='--',marker='None',label='Sediment Loading')
...
df['swell height'].plot(ax=ax1_2,color='b',ls='-',marker='None',label='Swell Ht')
...
## SSY input
ax2_2 = ax2.twinx()
ax2_2.set_ylabel('SSY (tons/day)',color='r')
...
### SSY
ax3_2 = ax3.twinx()
ax3_2.set_ylabel('SSY (tons/month)',color='r')
