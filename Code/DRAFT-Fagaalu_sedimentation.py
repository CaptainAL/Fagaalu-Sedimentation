...
document.add_paragraph("Many researchers and environmental managers are interested in determining the location and severity of terrigenous sediment impacts on coral health, but developing a measure of sediment impact has proven difficult. Several methods of measuring short-term (hourly to seasonal time scale) sediment accumulation have been developed, including discontinuous and quasi-continuous methods (Thomas 2004). Discontinuous methods require an observer to collect a sample on-site and so are labor-intensive and only yield an average rate of accumulation over the observation interval (days to months), but also allow the accumulated sediment to be further analyzed for composition. Quasi-continuous methods are more expensive and elaborate due to the use of electronic sensors and data loggers, but may be less labor intensive and yield sampling frequency only limited by the sensor and data logger, typically recording at frequencies of minutes for periods of several months. See Thomas (2004) for a full review of measurement methods. Due to their relative cost and simplicity, tube traps are the most common method for measuring sediment accumulation in shallow coral reef environments (Storlazzi et al., 2011; White, 1990), but it is difficult to determine if these are ecologically meaningful indicators of coral stress. Some corals are well-adapted to turbid conditions (Perry et al., 2012), and deposited sediment can be removed actively by the coral itself (Barnes 1999), or passively by wave action before it is lethal. The stress on the coral organism increases linearly with the deposition amount and the duration of exposure (Fabricius, 2005) but tube traps overestimate deposition and do not allow for sediment resuspension, making it impossible to evaluate the residence time of deposited sediment (Storlazzi et al., 2011). Sediment can accumulate due to primary and secondary deposition of particlse (see Thomas 2004 for a review of terms), so to more accurately quantify “net” sedimentation, Field et al. (2012) proposed the use of “SedPods” where a flat surface allows for resuspension, similar to the surrounding benthic substrate. While the complex interaction of sediment composition, hydrodynamics, and coral physiology are important, basic questions about location and controls on net terrigenous sediment accumulation rates are unknown at the study site.")

document.add_paragraph("Though some have shown good correlation between suspended sediment fluxes and rainfall (Meng 2008), several studies have found weak or no correlation between sediment trap collection and rainfall (Bothner et al., 2006; Victor et al., 2006) but it is well-known that SSY from small, mountainous watersheds can be poorly correlated with precipitation (Basher et al., 2011; Duvert et al., 2012). Poor correlation between river discharge and sediment accumulation has also been found even in tidal estuaries (Pasternack and Brush 1998). By correlating sediment trap accumulation with measured and modeled SSY from the watershed, this research proposes to develop a model of spatially distributed, monthly sediment accumulation as a function of watershed inputs and hydrodynamic conditions. The proposed modeling approach is similar to other efforts that have attempted to limit the complexity of the modeling approach, but still account for the impact of ocean conditions on sediment dynamics (Fabricius et al. 2012).")
