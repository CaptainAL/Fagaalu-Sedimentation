...
document.add_paragraph("The complex spatial and temporal interaction of terrigenous sediment inputs, sediment resuspension, and hydrodynamic circulation can significantly alter the quantity, composition, and residence time of sediment in coral reefs which are significant controls on coral ecology (Storlazzi et al., 2009) and influences coral communities at regional scales (Begin 2013). Several studies correlate long term sediment accumulation, and resulting decreased coral health, with increased sediment supply from the watershed (Ryan et al., 2008, PNG studies), but there is also strong evidence of hydrodynamics decreasing sediment residence time in two ways: 1) by flushing suspended sediment away from the corals before it can be deposited (residence time = 0 min), and 2) resuspending and removing sediment that has been previously deposited. In contrast to many small, mountainous watersheds in temperate coastal regions where fluvial discharge and wave energy commonly coincide (Warrick et al., 2004), discharge, deposition, and reworking of flood sediment are often decoupled on tropical islands, causing high deposition rates and residence times of terrigenous sediment (Draut et al., 2009; Storlazzi et al., 2009). Conversely, seasonal wind and wave patterns in the tradewind belt can be coupled with sediment discharge or resuspension to decrease sediment deposition and residence times (Hoitink and Hoekstra, 2003; Muzuka et al., 2010). Given the increase in sediment discharge to coastal waters caused by anthropogenic watershed disturbance on tropical islands, an integrated understanding of how flood-supplied terrigenous sediment and water circulation control sediment deposition and residence time is essential for identifying and mitigating coral health impacts (Draut et al., 2009).")

document.add_paragraph("Other studies rely on sediment cores to measure long term net sediment accumulation (Begin 2014) but short term exposure influences coral health. Other studies use GIS based sediment budgets to estimate SSY (Begin 2014, Ramos-Scharron lots) but this study uses actual measurements Begin (2014) adapted STJ-EROS to St. Lucia but a seidment yield from a similar size quarry was only predicted to be 0.2 percent of watershed contributions. Data in Faga'alu showed the quarry contributed 50 percent of SSY. Instead of sediment traps that may overestimate accumulation (storlazzi et al 2011), some studies in Caribbean (Brooks 2008, Ryan 2009, Begin 2012) and Hawaii (Draut 2009) use short lived radioisotopes in sediment cores to measure net accumulation. This study uses SedPods to resolve monthly accumulation differencees.")

document.add_paragraph("For a full review of effects of turbidity and sedimentation on coral health, see Erftemeijer et al (2012).")

document.add_paragraph("While total sedimentation rate is the most common measure of sedimentation reported in relation to coral cover, evidence is accumulating to suggest that sediment charac-teristics (e.g., size and composition) may also be important (Begin 2013). Fine grained (Weber 2006) organic rich (Weber 2012) is worse . On fringing reefs near volcanic lands, the noncalcareous fraction of reef sediment can be assumed to have originated from land (Brooks et al. 2007).")
...
document.add_paragraph("Though some have shown good correlation between suspended sediment fluxes and rainfall (Meng 2008), several studies have found weak or no correlation between sediment trap collection and rainfall (Bothner et al., 2006; Victor et al., 2006). Some show only good correlation near shore. It is well-known that SSY from small, mountainous watershed can be poorly correlated with precipitation (Basher et al., 2011; Duvert et al., 2012). Poor correlation between river discharge and sediment accumulation has also been found even in tidal estuaries (Pasternack and Brush 1998). By correlating sediment trap accumulation with measured and modeled SSY from the watershed, this research proposes to develop a model of spatially distributed, monthly sediment accumulation as a function of watershed inputs and hydrodynamic conditions. The proposed modeling approach is similar to other efforts that have attempted to limit the complexity of the modeling approach, but still account for the impact of ocean conditions on sediment dynamics (Fabricius et al. 2012).")
